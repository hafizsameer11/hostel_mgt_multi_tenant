    ...
    return (
        <div className="min-h-screen bg-white flex flex-col">
            ...
            <main className="flex-1">
                ...
                <section id="collections" className="px-6 sm:px-10 lg:px-16 py-16 space-y-16">
                ...
                <section className="px-6 sm:px-10 lg:px-16 pb-20 bg-gray-50">
